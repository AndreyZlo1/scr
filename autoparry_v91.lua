...
function State.ap.fireM1Custom(char, model, wantCombo, ignoreRate, priority, dropGuard)
	...
	pcall(function()
		...
		-- То есть баг не в самом свинге, а в том, ЧЕРЕЗ КАКОЕ ВРЕМЯ разрешён следующий.
		--
		...
		-- каждый следующий удар обрывал предыдущий на середине. И это не просто рестарт одного
...
--      н�� защищала, но приносила 4 ключа конф��га и тумблер. Убрано.
